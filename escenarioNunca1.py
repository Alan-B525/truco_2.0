...
cuando el Agente1 nunca canta envido,y su estilo de juego es CAUTELOSO contra un Agente 2 
...
for i in range(N):
    ...
    agente1 = Agente(True, "Cauteloso", cartasRepartir[0:3], partidaConFlor)
